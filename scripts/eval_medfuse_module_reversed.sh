...
--fusion_type lstm \
--save_dir /content/drive/MyDrive/medfuse_checkpoints/fusion_partial/reversed/eval \
--load_state /content/drive/MyDrive/medfuse_checkpoints/fusion_partial/reversed/best_checkpoint.pth.tar
